...
#if !WIGNER6J_REGGE_CANONICALISE_IN_STRUCT
  uint32_t two_j1 =  two_jv[0];
  uint32_t two_j2 =  two_jv[1];
  uint32_t two_j3 =  two_jv[2];
  uint32_t two_j4 =  two_jv[3];
  uint32_t two_j5 =  two_jv[4];
  uint32_t two_j6 =  two_jv[5];
#endif
